...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      // AppKit pop-up button style
      "flex h-[34px] w-full items-center justify-between rounded-[8px] px-3 py-0",
      "text-[13px]",
      ...
      "focus:shadow-[inset_0_1px_2px_rgba(0,0,0,0.04),0_0_0_3px_rgba(0,122,255,0.25)]",
...
>(({ className, children, position = "popper", ...props }, ref) => (
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ref={ref}
      className={cn(
        // macOS popup menu / SwiftUI Picker panel
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ref={ref}
    className={cn(
      // macOS menu item style
      "relative flex w-full cursor-default select-none items-center rounded-[7px] py-[6px] pl-8 pr-2",
      "text-[13px] outline-none",
      "focus:bg-[#007AFF] focus:text-white",
      "dark:focus:bg-[#0A84FF]",
